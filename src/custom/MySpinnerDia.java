...
public class MySpinnerDia extends javax.swing.JPanel {
    ...
    public void setValue(int Value) {
        ...
        this.editor.setText(dia.nombreDiacomp(Value));
        modifyInitedComponents();
...
//    }
    ...
    private void initComponents() {
        ...
        inerpanel.setPreferredSize(new java.awt.Dimension(150, 20));
        ...
        inerpanel.add(left);
        left.setBounds(140, 0, 20, 20);

        add(inerpanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 160, 20));
    ...
    private void rightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rightActionPerformed
        ...
        editor.setText(dia.nombreDiacomp(Value));
    ...
    private void modifyInitedComponents(){
        ...
        this.left.setBounds(160-20, 0,20,this.getHeight());
        
        this.right.setLocation(0,0);
        right.setSize(20,this.getHeight());
        
        
        this.editor.setBounds(right.getWidth(), 0,120, getHeight());
        editor.setText(dia.nombreDiacomp(Value));
